...
int main() {
    ...
    print(FBLU(BOLD("Running scalar benchmark for non-isomorphic tensor products\n")));
    print("1 Index contraction: single precision");
    ...
    print("1 Index contraction: double precision");
    ...
    print("2 Index contraction: single precision");
    ...
    print("2 Index contraction: double precision");
    ...
    print("3 Index contraction: single precision");
    ...
    print("3 Index contraction: double precision");
    ...
    print("8 Index contraction: single precision");
    ...
    print("8 Index contraction: double precision");
