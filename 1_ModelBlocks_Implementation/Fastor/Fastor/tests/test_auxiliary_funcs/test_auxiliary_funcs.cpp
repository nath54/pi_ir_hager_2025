...
int main() {
...

    {
...

        {
            ...
            size_t a1 = internal::match_indices_from_end_index(ind0, ind1);
            FASTOR_DOES_CHECK_PASS(a1==1);
            size_t a2 = internal::match_indices_from_end_index(ind1, ind0);
            FASTOR_DOES_CHECK_PASS(a2==1);
        }
...

    {
...

        {
            ...
            size_t a1 = internal::match_indices_from_start_index(ind0, ind1);
            FASTOR_DOES_CHECK_PASS(a1==2);
            size_t a2 = internal::match_indices_from_start_index(ind1, ind0);
            FASTOR_DOES_CHECK_PASS(a2==2);
        }
    }
...

    {
        ...
        FASTOR_DOES_CHECK_PASS(is_mat_vec == true);
        FASTOR_DOES_CHECK_PASS(is_vec_mat == false);
        FASTOR_DOES_CHECK_PASS(is_mat_mat == false);
    }

    {
        ...
        FASTOR_DOES_CHECK_PASS(is_mat_vec == false);
        FASTOR_DOES_CHECK_PASS(is_vec_mat == true);
        FASTOR_DOES_CHECK_PASS(is_mat_mat == false);
    }

    {
        ...
        FASTOR_DOES_CHECK_PASS(is_mat_vec == false);
        FASTOR_DOES_CHECK_PASS(is_vec_mat == false);
        FASTOR_DOES_CHECK_PASS(is_mat_mat == true);
    }
