...
/*****************************************************************************/
#define _STAI_NETWORK_MODEL_SIGNATURE     "0x164ee060b14d3f75e2e1c38fcc8a0410"
#define _STAI_NETWORK_DATETIME            "2026-01-22T15:15:40+0000"
...
static const stai_network_info g_network_info = {
  ...
  .inputs = (stai_tensor[STAI_NETWORK_IN_NUM]) {
    STAI_INIT_TENSOR(
      ...
      STAI_DECLARE_ARRAY(float, 1, 0.003920537419617176f),
    ...
    STAI_INIT_TENSOR(
      ...
      STAI_DECLARE_ARRAY(float, 1, 0.0009466722840443254f),
  ...
  .activations = (stai_tensor[STAI_NETWORK_ACTIVATIONS_NUM]) {
    STAI_INIT_TENSOR(
      ...
      STAI_DECLARE_ARRAY(int32_t, 1, 1444),
      STAI_EMPTY_ARRAY(),
      STAI_EMPTY_ARRAY()),
    },
  .weights = (stai_tensor[STAI_NETWORK_WEIGHTS_NUM]) {
    STAI_INIT_TENSOR(
      ...
      STAI_DECLARE_ARRAY(int32_t, 1, 724),
      STAI_EMPTY_ARRAY(),
      STAI_EMPTY_ARRAY()),
    },
...
AI_INTQ_INFO_LIST_OBJ_DECLARE(_MatMul_output_0_output_array_intq, AI_STATIC,
  ...
  AI_PACK_INTQ_INFO(
    AI_PACK_INTQ_SCALE(0.006418135482817888f),
    AI_PACK_INTQ_ZP(3)))
...
AI_INTQ_INFO_LIST_OBJ_DECLARE(_Relu_output_0_output_array_intq, AI_STATIC,
  AI_BUFFER_META_FLAG_SCALE_FLOAT|AI_BUFFER_META_FLAG_ZEROPOINT_S8, 1,
  AI_PACK_INTQ_INFO(
    AI_PACK_INTQ_SCALE(0.0036214753054082394f),
    AI_PACK_INTQ_ZP(-128)))

/* Int quant #2 */
AI_INTQ_INFO_LIST_OBJ_DECLARE(_Constant_2_output_0_DequantizeLinear_Output_const_3D_array_intq, AI_STATIC,
  AI_BUFFER_META_FLAG_SCALE_FLOAT|AI_BUFFER_META_FLAG_ZEROPOINT_S8, 1,
  AI_PACK_INTQ_INFO(
    AI_PACK_INTQ_SCALE(0.0021939140278846025f),
    AI_PACK_INTQ_ZP(0)))
...
/* Array#2 */
AI_ARRAY_OBJ_DECLARE(
  _Constant_2_output_0_DequantizeLinear_Output_const_3D_array, AI_ARRAY_FORMAT_S8,
...
AI_TENSOR_OBJ_DECLARE(
  _Constant_2_output_0_DequantizeLinear_Output_const_3D, AI_STATIC,
  0, 0x1,
  AI_SHAPE_INIT(4, 1, 16, 1, 1), AI_STRIDE_INIT(4, 1, 1, 16, 16),
  1, &_Constant_2_output_0_DequantizeLinear_Output_const_3D_array, &_Constant_2_output_0_DequantizeLinear_Output_const_3D_array_intq)
...
AI_TENSOR_CHAIN_OBJ_DECLARE(
  ...
  AI_TENSOR_LIST_OBJ_INIT(AI_FLAG_NONE, 2, &_Constant_2_output_0_DequantizeLinear_Output_const_3D, &_MatMul_output_0_output),
...
{
  _Constant_2_output_0_DequantizeLinear_Output_const_3D_array.data = AI_PTR(net_ctx->_weights[0] + 0);
  _Constant_2_output_0_DequantizeLinear_Output_const_3D_array.data_start = AI_PTR(net_ctx->_weights[0] + 0);
  ...
  _STAI_NETWORK_EVENT_NODE_START_CB(10, 2, { _Constant_2_output_0_DequantizeLinear_Output_const_3D.data->data,_MatMul_output_0_output.data->data});
  forward_eltwise_integer_INT8(&_Relu_output_0_layer);
  _STAI_NETWORK_EVENT_NODE_STOP_CB(10, 1, { _Relu_output_0_output.data->data});
}
...
static const ai_i8 _MatMul_output_0_t_out_0_fmt_zero_const_s8 = 3;
static const ai_float _MatMul_output_0_t_in_0_fmt_scale_const_f32 = 0.003920537419617176f;
static const ai_float _MatMul_output_0_t_out_0_fmt_scale_const_f32 = 0.006418135482817888f;
static const ai_float _MatMul_output_0_t_weight_0_fmt_scale_const_f32[] = LITE_ARRAY_VALUES(0.002451461274176836f, 0.0021535763517022133f, 0.001949957455508411f, 0.002258205320686102f, 0.0022942230571061373f, 0.002470833482220769f, 0.002462306059896946f, 0.002284799236804247f, 0.0021829702891409397f, 0.0022620533127337694f, 0.0023517291992902756f, 0.002366335829719901f, 0.0024505830369889736f, 0.0022923466749489307f, 0.0024045666214078665f, 0.0023472141474485397f);
...
static const ai_u16 output_QuantizeLinear_Input_t_in_0_shape_ch_const_u16 = 480;
...
static const ai_float output_QuantizeLinear_Input_t_in_0_fmt_scale_const_f32 = 0.0036214753054082394f;
static const ai_float output_QuantizeLinear_Input_t_out_0_fmt_scale_const_f32 = 0.0009466722840443254f;
static const ai_float output_QuantizeLinear_Input_t_weight_0_fmt_scale_const_f32 = 0.00035885273246094584f;
STAI_API_ENTRY
  ...
  const stai_run_mode mode)
{
  ...
  _STAI_NETWORK_EVENT_NODE_START_CB(7, 1, {(stai_ptr) _MatMul_output_0_t_in_0_ptr_const_s8});
  ...
  _STAI_NETWORK_EVENT_NODE_STOP_CB(7, 1, {(stai_ptr) _MatMul_output_0_t_out_0_ptr_s8});
  }
  ...
  /* LITE_KERNEL_SECTION BEGIN output_QuantizeLinear_Input */
  {
    ...
    const ai_i8* output_QuantizeLinear_Input_t_weight_0_ptr_const_s8 = (ai_i8*)(net_ctx->_weights[0] + 240);
    const ai_i32* output_QuantizeLinear_Input_t_weight_1_ptr_const_s32 = (ai_i32*)(net_ctx->_weights[0] + 720);
    ai_i16* output_QuantizeLinear_Input_t_scratch_0_ptr_s16 = (ai_i16*)(net_ctx->_activations[0] + 480);
  
  _STAI_NETWORK_EVENT_NODE_START_CB(16, 1, {(stai_ptr) output_QuantizeLinear_Input_t_in_0_ptr_const_s8});
  ...
  _STAI_NETWORK_EVENT_NODE_STOP_CB(16, 1, {(stai_ptr) output_QuantizeLinear_Input_t_out_0_ptr_s8});
  }
...
const uintptr_t _activations_alignment[] = STAI_NETWORK_ACTIVATIONS_ALIGNMENTS;
  ...
  net_ctx->_outputs[0] = activations[0] + 1440;
_stai_network_check(net_ctx);
  return net_ctx->_return_code;
}
