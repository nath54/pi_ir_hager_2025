...
#define AI_NETWORK_ORIGIN_MODEL_NAME   "model_simple_lin_n_8_perchannel_quant_random_1"
...
#define AI_NETWORK_IN_1_SIZE        (300)
#define AI_NETWORK_IN_1_SIZE_BYTES  (300)
