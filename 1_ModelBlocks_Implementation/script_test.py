...
#
### Initialize tracking system once at the beginning. ###
#
from core.lib_impl.lib_track import init_track
import builtins
from core.lib_impl.lib_track import track
builtins.track = track
init_track()
...
TESTS: list[ tuple[str, tuple[int, ...], str, Optional[str]] ] = [
    ...
    ("simple_conv_model_2.py", (2, 3, 32, 32), "SimpleConvModel", None),
    ("simple_maxpool_model.py", (2, 3, 32, 32), "Model", None),
    ("simple_avgpool_model.py", (2, 3, 32, 32), "Model", None),
    ("simple_adavgpool_model.py", (2, 3, 32, 32), "Model", None),
