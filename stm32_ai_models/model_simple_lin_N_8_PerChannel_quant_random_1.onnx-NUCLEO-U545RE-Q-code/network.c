...
/*****************************************************************************/
#define _STAI_NETWORK_MODEL_SIGNATURE     "0x3f9f5ad411cd8e5684d54f005d606585"
#define _STAI_NETWORK_DATETIME            "2026-01-22T14:22:06+0000"
...
static const stai_network_info g_network_info = {
  ...
  .inputs = (stai_tensor[STAI_NETWORK_IN_NUM]) {
    STAI_INIT_TENSOR(
      ...
      STAI_DECLARE_ARRAY(float, 1, 0.0039215292781591415f),
    ...
    STAI_INIT_TENSOR(
      ...
      STAI_DECLARE_ARRAY(float, 1, 1.1758579603338148e-05f),
      STAI_DECLARE_ARRAY(int16_t, 1, -128)),
    },
...
AI_INTQ_INFO_LIST_OBJ_DECLARE(_MatMul_output_0_output_array_intq, AI_STATIC,
  ...
  AI_PACK_INTQ_INFO(
    AI_PACK_INTQ_SCALE(0.008880025707185268f),
    AI_PACK_INTQ_ZP(-28)))
...
AI_INTQ_INFO_LIST_OBJ_DECLARE(_Relu_output_0_output_array_intq, AI_STATIC,
  AI_BUFFER_META_FLAG_SCALE_FLOAT|AI_BUFFER_META_FLAG_ZEROPOINT_S8, 1,
  AI_PACK_INTQ_INFO(
    AI_PACK_INTQ_SCALE(0.006296840030699968f),
    AI_PACK_INTQ_ZP(-128)))
...
AI_INTQ_INFO_LIST_OBJ_DECLARE(_Relu_1_output_0_output_array_intq, AI_STATIC,
  AI_BUFFER_META_FLAG_SCALE_FLOAT|AI_BUFFER_META_FLAG_ZEROPOINT_S8, 1,
  AI_PACK_INTQ_INFO(
    AI_PACK_INTQ_SCALE(0.001736778300255537f),
    AI_PACK_INTQ_ZP(-128)))
...
AI_INTQ_INFO_LIST_OBJ_DECLARE(_Relu_2_output_0_output_array_intq, AI_STATIC,
  AI_BUFFER_META_FLAG_SCALE_FLOAT|AI_BUFFER_META_FLAG_ZEROPOINT_S8, 1,
  AI_PACK_INTQ_INFO(
    AI_PACK_INTQ_SCALE(0.0010356608545407653f),
    AI_PACK_INTQ_ZP(-128)))
...
AI_INTQ_INFO_LIST_OBJ_DECLARE(_Relu_3_output_0_output_array_intq, AI_STATIC,
  AI_BUFFER_META_FLAG_SCALE_FLOAT|AI_BUFFER_META_FLAG_ZEROPOINT_S8, 1,
  AI_PACK_INTQ_INFO(
    AI_PACK_INTQ_SCALE(0.0006629059207625687f),
    AI_PACK_INTQ_ZP(-128)))
...
AI_INTQ_INFO_LIST_OBJ_DECLARE(_Relu_4_output_0_output_array_intq, AI_STATIC,
  AI_BUFFER_META_FLAG_SCALE_FLOAT|AI_BUFFER_META_FLAG_ZEROPOINT_S8, 1,
  AI_PACK_INTQ_INFO(
    AI_PACK_INTQ_SCALE(0.000358696561306715f),
    AI_PACK_INTQ_ZP(-128)))
...
AI_INTQ_INFO_LIST_OBJ_DECLARE(_Relu_5_output_0_output_array_intq, AI_STATIC,
  AI_BUFFER_META_FLAG_SCALE_FLOAT|AI_BUFFER_META_FLAG_ZEROPOINT_S8, 1,
  AI_PACK_INTQ_INFO(
    AI_PACK_INTQ_SCALE(0.0005027709994465113f),
    AI_PACK_INTQ_ZP(-128)))
...
AI_INTQ_INFO_LIST_OBJ_DECLARE(_Relu_6_output_0_output_array_intq, AI_STATIC,
  AI_BUFFER_META_FLAG_SCALE_FLOAT|AI_BUFFER_META_FLAG_ZEROPOINT_S8, 1,
  AI_PACK_INTQ_INFO(
    AI_PACK_INTQ_SCALE(0.00045403518015518785f),
    AI_PACK_INTQ_ZP(-128)))
...
static const ai_i8 _MatMul_output_0_t_out_0_fmt_zero_const_s8 = -28;
static const ai_float _MatMul_output_0_t_in_0_fmt_scale_const_f32 = 0.0039215292781591415f;
static const ai_float _MatMul_output_0_t_out_0_fmt_scale_const_f32 = 0.008880025707185268f;
...
static const ai_float output_QuantizeLinear_Input_t_in_0_fmt_scale_const_f32 = 0.00045403518015518785f;
static const ai_float output_QuantizeLinear_Input_t_out_0_fmt_scale_const_f32 = 1.1758579603338148e-05f;
