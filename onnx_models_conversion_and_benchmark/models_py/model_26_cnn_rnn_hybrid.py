"""
Model Name: CNN + RNN Hybrid (Deep Scalable Version)
...
Architecture:
    ...
    - GRU (B, seq_len, channels) -> (B, seq_len, h0)
...
class Model(nn.Module):
    ...
    def forward(self, x: Tensor) -> Tensor:
        ...
        x, _ = self.gru(x)              # (B, L_final, C_final) -> (B, L_final, h0)
