...
/*****************************************************************************/
#define _STAI_NETWORK_MODEL_SIGNATURE     "0xb7230355f7be6915ce6d7d2a141c0d8a"
#define _STAI_NETWORK_DATETIME            "2026-01-22T15:42:32+0000"
...
static const stai_network_info g_network_info = {
  ...
  .inputs = (stai_tensor[STAI_NETWORK_IN_NUM]) {
    STAI_INIT_TENSOR(
      ...
      STAI_DECLARE_ARRAY(float, 1, 0.0039206212386488914f),
    ...
    STAI_INIT_TENSOR(
      ...
      STAI_DECLARE_ARRAY(float, 1, 6.971834227442741e-05f),
  ...
  .activations = (stai_tensor[STAI_NETWORK_ACTIVATIONS_NUM]) {
    STAI_INIT_TENSOR(
      ...
      STAI_DECLARE_ARRAY(int32_t, 1, 36432),
      STAI_EMPTY_ARRAY(),
      STAI_EMPTY_ARRAY()),
    },
  .weights = (stai_tensor[STAI_NETWORK_WEIGHTS_NUM]) {
    STAI_INIT_TENSOR(
      ...
      STAI_DECLARE_ARRAY(int32_t, 1, 16860),
      STAI_EMPTY_ARRAY(),
      STAI_EMPTY_ARRAY()),
    },
...
AI_INTQ_INFO_LIST_OBJ_DECLARE(input_output_array_intq, AI_STATIC,
  ...
  AI_PACK_INTQ_INFO(
    AI_PACK_INTQ_SCALE(0.0039206212386488914f),
    AI_PACK_INTQ_ZP(-128)))
...
/* Int quant #2 */
AI_INTQ_INFO_LIST_OBJ_DECLARE(_Relu_2_output_0_0_0__Flatten_output_0_to_chlast_conversion_output_array_intq, AI_STATIC,
  AI_BUFFER_META_FLAG_SCALE_FLOAT|AI_BUFFER_META_FLAG_ZEROPOINT_S8, 1,
  AI_PACK_INTQ_INFO(
    AI_PACK_INTQ_SCALE(0.0005715792067348957f),
    AI_PACK_INTQ_ZP(-128)))
...
/* Array#2 */
AI_ARRAY_OBJ_DECLARE(
  _Relu_2_output_0_0_0__Flatten_output_0_to_chlast_conversion_output_array, AI_ARRAY_FORMAT_S8,
...
AI_TENSOR_OBJ_DECLARE(
  ...
  0, 0x1,
  AI_SHAPE_INIT(4, 1, 10, 30, 18), AI_STRIDE_INIT(4, 1, 1, 10, 300),
  1, &_Flatten_output_0_to_chlast_output_array, &_Flatten_output_0_to_chlast_output_array_intq)

/* Tensor #3 */
AI_TENSOR_OBJ_DECLARE(
  _Relu_2_output_0_0_0__Flatten_output_0_to_chlast_conversion_output, AI_STATIC,
  7, 0x1,
  AI_SHAPE_INIT(4, 1, 18, 10, 30), AI_STRIDE_INIT(4, 1, 1, 18, 180),
  1, &_Relu_2_output_0_0_0__Flatten_output_0_to_chlast_conversion_output_array, &_Relu_2_output_0_0_0__Flatten_output_0_to_chlast_conversion_output_array_intq)
...
AI_LAYER_OBJ_DECLARE(
  _Unsqueeze_output_0_to_chfirst_layer, 9,
...
AI_TENSOR_CHAIN_OBJ_DECLARE(
  ...
  AI_TENSOR_LIST_OBJ_INIT(AI_FLAG_NONE, 1, &_Relu_2_output_0_0_0__Flatten_output_0_to_chlast_conversion_output),
...
AI_LAYER_OBJ_DECLARE(
  _Flatten_output_0_to_chlast_layer, 30,
  TRANSPOSE_TYPE, 0x0, NULL,
  transpose, forward_transpose,
...
void forward_lite__Unsqueeze_output_0_to_chfirst(_stai_network_context* net_ctx)
{
  ...
  _Unsqueeze_output_0_to_chfirst_output_array.data = AI_PTR(net_ctx->_activations[0] + 19044);
  _Unsqueeze_output_0_to_chfirst_output_array.data_start = AI_PTR(net_ctx->_activations[0] + 19044);
  _STAI_NETWORK_EVENT_NODE_START_CB(9, 1, { input_output0.data->data});
  forward_transpose(&_Unsqueeze_output_0_to_chfirst_layer);
  _STAI_NETWORK_EVENT_NODE_STOP_CB(9, 1, { _Unsqueeze_output_0_to_chfirst_output.data->data});
}
void forward_lite__Flatten_output_0_to_chlast(_stai_network_context* net_ctx)
{
  _Relu_2_output_0_0_0__Flatten_output_0_to_chlast_conversion_output_array.data = AI_PTR(net_ctx->_activations[0] + 21600);
  _Relu_2_output_0_0_0__Flatten_output_0_to_chlast_conversion_output_array.data_start = AI_PTR(net_ctx->_activations[0] + 21600);
  _Flatten_output_0_to_chlast_output_array.data = AI_PTR(net_ctx->_activations[0] + 0);
  _Flatten_output_0_to_chlast_output_array.data_start = AI_PTR(net_ctx->_activations[0] + 0);
  _STAI_NETWORK_EVENT_NODE_START_CB(30, 1, { _Relu_2_output_0_0_0__Flatten_output_0_to_chlast_conversion_output.data->data});
  forward_transpose(&_Flatten_output_0_to_chlast_layer);
  _STAI_NETWORK_EVENT_NODE_STOP_CB(30, 1, { _Flatten_output_0_to_chlast_output.data->data});
}
...
static const ai_float _Relu_output_0_t_in_0_fmt_scale_const_f32 = 0.0039206212386488914f;
static const ai_float _Relu_output_0_t_out_0_fmt_scale_const_f32 = 0.002955144504085183f;
static const ai_float _Relu_output_0_t_weight_0_fmt_scale_const_f32[] = LITE_ARRAY_VALUES(0.0018922144081443548f, 0.0024508254136890173f, 0.002421327168121934f, 0.002207197481766343f, 0.002424101112410426f, 0.0025719329714775085f, 0.0020468297880142927f, 0.002053530653938651f);
...
static const ai_u32 _MaxPool_output_0_DequantizeLinear_Output_t_out_0_shape_h_w_ch_d_prod_const_u32 = 2400;
static const ai_float _MaxPool_output_0_DequantizeLinear_Output_t_in_0_fmt_scale_const_f32 = 0.002955144504085183f;
static const ai_i8 _MaxPool_output_0_DequantizeLinear_Output_t_in_0_fmt_zero_const_s8 = -128;

static const ai_u32 _Relu_1_output_0_t_in_0_shape_ch_const_u32 = 8;
static const ai_u32 _Relu_1_output_0_t_out_0_shape_ch_const_u32 = 12;
...
static const ai_u32 _Relu_2_output_0_t_in_0_shape_ch_const_u32 = 12;
static const ai_u32 _Relu_2_output_0_t_out_0_shape_ch_const_u32 = 18;
...
static const ai_u32 _Relu_2_output_0_0_0__Flatten_output_0_to_chlast_conversion_t_out_0_shape_h_w_ch_d_prod_const_u32 = 5400;
static const ai_float _Relu_2_output_0_0_0__Flatten_output_0_to_chlast_conversion_t_out_0_fmt_scale_const_f32 = 0.0005715792067348957f;
static const ai_i8 _Relu_2_output_0_0_0__Flatten_output_0_to_chlast_conversion_t_out_0_fmt_zero_const_s8 = -128;


static const ai_i8 output_QuantizeLinear_Input_t_in_0_fmt_zero_const_s8 = -128;
static const ai_i8 output_QuantizeLinear_Input_t_out_0_fmt_zero_const_s8 = -40;
static const ai_u16 output_QuantizeLinear_Input_t_in_0_shape_ch_const_u16 = 5400;
...
static const ai_float output_QuantizeLinear_Input_t_in_0_fmt_scale_const_f32 = 0.0005715792067348957f;
static const ai_float output_QuantizeLinear_Input_t_out_0_fmt_scale_const_f32 = 6.971834227442741e-05f;
static const ai_float output_QuantizeLinear_Input_t_weight_0_fmt_scale_const_f32 = 0.00010712681978475302f;
STAI_API_ENTRY
  ...
  const stai_run_mode mode)
{
  ...
  {
      const ai_i8* _Relu_output_0_t_in_0_ptr_const_s8 = (ai_i8*)(net_ctx->_activations[0] + 19044);
    const ai_i8* _Relu_output_0_t_weight_0_ptr_const_s8 = (ai_i8*)(net_ctx->_weights[0] + 0);
    const ai_i32* _Relu_output_0_t_weight_1_ptr_const_s32 = (ai_i32*)(net_ctx->_weights[0] + 72);
    ai_i8* _Relu_output_0_t_out_0_ptr_s8 = (ai_i8*)(net_ctx->_activations[0] + 19344);
    ai_i16* _Relu_output_0_t_scratch_0_ptr_s16 = (ai_i16*)(net_ctx->_activations[0] + 18744);
  ...
  {
      const ai_i8* _MaxPool_output_0_DequantizeLinear_Output_t_in_0_ptr_const_s8 = (ai_i8*)(net_ctx->_activations[0] + 19344);
    ai_float* _MaxPool_output_0_DequantizeLinear_Output_t_out_0_ptr_f32 = (ai_float*)(net_ctx->_activations[0] + 12144);
  
  _STAI_NETWORK_EVENT_NODE_START_CB(17, 1, {(stai_ptr) _MaxPool_output_0_DequantizeLinear_Output_t_in_0_ptr_const_s8});
  ...
  _STAI_NETWORK_EVENT_NODE_STOP_CB(17, 1, {(stai_ptr) _MaxPool_output_0_DequantizeLinear_Output_t_out_0_ptr_f32});
  }
  /* LITE_KERNEL_SECTION END _MaxPool_output_0_DequantizeLinear_Output */
  /* LITE_KERNEL_SECTION BEGIN _Relu_1_output_0 */
  {
      const ai_float* _Relu_1_output_0_t_in_0_ptr_const_f32 = (ai_float*)(net_ctx->_activations[0] + 12144);
    ai_float* _Relu_1_output_0_t_out_0_ptr_f32 = (ai_float*)(net_ctx->_activations[0] + 22032);
    const ai_u8* _Relu_1_output_0_t_weight_0_ptr_const_u8 = (ai_u8*)(net_ctx->_weights[0] + 104);
    const ai_u8* _Relu_1_output_0_t_weight_1_ptr_const_u8 = (ai_u8*)(net_ctx->_weights[0] + 3560);
    ai_float* _Relu_1_output_0_t_scratch_0_ptr_f32 = (ai_float*)(net_ctx->_activations[0] + 21744);
  
  _STAI_NETWORK_EVENT_NODE_START_CB(18, 1, {(stai_ptr) _Relu_1_output_0_t_in_0_ptr_const_f32});
  ...
  _STAI_NETWORK_EVENT_NODE_STOP_CB(18, 1, {(stai_ptr) _Relu_1_output_0_t_out_0_ptr_f32});
  }
  /* LITE_KERNEL_SECTION END _Relu_1_output_0 */
  /* LITE_KERNEL_SECTION BEGIN _Relu_2_output_0 */
  {
      const ai_float* _Relu_2_output_0_t_in_0_ptr_const_f32 = (ai_float*)(net_ctx->_activations[0] + 22032);
    ai_float* _Relu_2_output_0_t_out_0_ptr_f32 = (ai_float*)(net_ctx->_activations[0] + 0);
    const ai_u8* _Relu_2_output_0_t_weight_0_ptr_const_u8 = (ai_u8*)(net_ctx->_weights[0] + 3608);
    const ai_u8* _Relu_2_output_0_t_weight_1_ptr_const_u8 = (ai_u8*)(net_ctx->_weights[0] + 11384);
    ai_float* _Relu_2_output_0_t_scratch_0_ptr_f32 = (ai_float*)(net_ctx->_activations[0] + 21600);
  
  _STAI_NETWORK_EVENT_NODE_START_CB(24, 1, {(stai_ptr) _Relu_2_output_0_t_in_0_ptr_const_f32});
  ...
  _STAI_NETWORK_EVENT_NODE_STOP_CB(24, 1, {(stai_ptr) _Relu_2_output_0_t_out_0_ptr_f32});
  }
  /* LITE_KERNEL_SECTION END _Relu_2_output_0 */
  /* LITE_KERNEL_SECTION BEGIN _Relu_2_output_0_0_0__Flatten_output_0_to_chlast_conversion */
  {
      const ai_float* _Relu_2_output_0_0_0__Flatten_output_0_to_chlast_conversion_t_in_0_ptr_const_f32 = (ai_float*)(net_ctx->_activations[0] + 0);
    ai_i8* _Relu_2_output_0_0_0__Flatten_output_0_to_chlast_conversion_t_out_0_ptr_s8 = (ai_i8*)(net_ctx->_activations[0] + 21600);
  
  _STAI_NETWORK_EVENT_NODE_START_CB(24, 1, {(stai_ptr) _Relu_2_output_0_0_0__Flatten_output_0_to_chlast_conversion_t_in_0_ptr_const_f32});
    
  forward_lite_node_convert_integer_if32os8(_Relu_2_output_0_0_0__Flatten_output_0_to_chlast_conversion_t_in_0_ptr_const_f32, _Relu_2_output_0_0_0__Flatten_output_0_to_chlast_conversion_t_out_0_ptr_s8, _Relu_2_output_0_0_0__Flatten_output_0_to_chlast_conversion_t_out_0_shape_h_w_ch_d_prod_const_u32, _Relu_2_output_0_0_0__Flatten_output_0_to_chlast_conversion_t_out_0_fmt_scale_const_f32, _Relu_2_output_0_0_0__Flatten_output_0_to_chlast_conversion_t_out_0_fmt_zero_const_s8);
    
  _STAI_NETWORK_EVENT_NODE_STOP_CB(24, 1, {(stai_ptr) _Relu_2_output_0_0_0__Flatten_output_0_to_chlast_conversion_t_out_0_ptr_s8});
  }
  /* LITE_KERNEL_SECTION END _Relu_2_output_0_0_0__Flatten_output_0_to_chlast_conversion */
  ...
  /* LITE_KERNEL_SECTION BEGIN output_QuantizeLinear_Input */
  {
    ...
    const ai_i8* output_QuantizeLinear_Input_t_weight_0_ptr_const_s8 = (ai_i8*)(net_ctx->_weights[0] + 11456);
    const ai_i32* output_QuantizeLinear_Input_t_weight_1_ptr_const_s32 = (ai_i32*)(net_ctx->_weights[0] + 16856);
    ai_i16* output_QuantizeLinear_Input_t_scratch_0_ptr_s16 = (ai_i16*)(net_ctx->_activations[0] + 5400);
...
const uintptr_t _activations_alignment[] = STAI_NETWORK_ACTIVATIONS_ALIGNMENTS;
  ...
  net_ctx->_inputs[0] = activations[0] + 18744;

  net_ctx->_outputs[0] = activations[0] + 16200;
_stai_network_check(net_ctx);
  return net_ctx->_return_code;
}
