...
/*****************************************************************************/
#define _STAI_NETWORK_MODEL_SIGNATURE     "0x1cd5bd2a7a0632ec88837535d9b2bf19"
#define _STAI_NETWORK_DATETIME            "2026-01-22T14:11:25+0000"
...
static const stai_network_info g_network_info = {
  ...
  .weights = (stai_tensor[STAI_NETWORK_WEIGHTS_NUM]) {
    STAI_INIT_TENSOR(
      ...
      STAI_DECLARE_ARRAY(int32_t, 1, 147524),
      STAI_EMPTY_ARRAY(),
      STAI_EMPTY_ARRAY()),
    },
...
static const ai_i32 _Relu_4_output_0_t_in_0_shape_ch_prod_const_s32 = 64;


static const ai_i32 _Relu_5_output_0_t_in_0_shape_ch_prod_const_s32 = 32;


static const ai_i32 _Relu_6_output_0_t_in_0_shape_ch_prod_const_s32 = 16;
  ...
  const stai_run_mode mode)
{
  ...
  _STAI_NETWORK_EVENT_NODE_START_CB(18, 1, {(stai_ptr) (float*)(net_ctx->_activations[0] + 128)});
  ...
  _STAI_NETWORK_EVENT_NODE_STOP_CB(21, 1, {(stai_ptr) (float*)(net_ctx->_activations[0] + 256)});
  }
  ...
  /* LITE_KERNEL_SECTION BEGIN _Gemm_3_output_0 */
  {
      ...
      .bias = (float*)(net_ctx->_weights[0] + 136768),
      .n_channel_in = 128,
      .n_channel_out = 64,
      .n_elements = 1,
    };
  
  _STAI_NETWORK_EVENT_NODE_START_CB(24, 1, {(stai_ptr) (float*)(net_ctx->_activations[0] + 768)});
  ...
  {
      ai_handle _Relu_4_output_0_t_out_0_ptr_handle = (ai_handle)(net_ctx->_activations[0] + 256);
  ...
  /* LITE_KERNEL_SECTION BEGIN _Gemm_4_output_0 */
  {
      ...
      .weights = (float*)(net_ctx->_weights[0] + 137024),
      .bias = (float*)(net_ctx->_weights[0] + 145216),
      .n_channel_in = 64,
      .n_channel_out = 32,
      .n_elements = 1,
    };
  
  _STAI_NETWORK_EVENT_NODE_START_CB(27, 1, {(stai_ptr) (float*)(net_ctx->_activations[0] + 256)});
  ...
  {
      ai_handle _Relu_5_output_0_t_out_0_ptr_handle = (ai_handle)(net_ctx->_activations[0] + 128);
  ...
  /* LITE_KERNEL_SECTION BEGIN _Gemm_5_output_0 */
  {
      ...
      .output = (float*)(net_ctx->_activations[0] + 0),
      .input = (float*)(net_ctx->_activations[0] + 128),
      .weights = (float*)(net_ctx->_weights[0] + 145344),
      .bias = (float*)(net_ctx->_weights[0] + 147392),
      .n_channel_in = 32,
      .n_channel_out = 16,
      .n_elements = 1,
    };
  
  _STAI_NETWORK_EVENT_NODE_START_CB(30, 1, {(stai_ptr) (float*)(net_ctx->_activations[0] + 128)});
  ...
  {
      ai_handle _Relu_6_output_0_t_out_0_ptr_handle = (ai_handle)(net_ctx->_activations[0] + 64);
  ...
  /* LITE_KERNEL_SECTION BEGIN output */
  {
      ...
      .weights = (float*)(net_ctx->_weights[0] + 147456),
      .bias = (float*)(net_ctx->_weights[0] + 147520),
      .n_channel_in = 16,
      .n_channel_out = 1,
      .n_elements = 1,
    };
  
  _STAI_NETWORK_EVENT_NODE_START_CB(33, 1, {(stai_ptr) (float*)(net_ctx->_activations[0] + 64)});
