...
class Model(nn.Module):
    ...
    ### Init Method. ###
    #
    def __init__(self, c0: int = 8, k0: int = 3, h0: int = 16) -> None:
        ...
        #
        self.gru: nn.GRU = nn.GRU(input_size=c0, hidden_size=h0, batch_first=True)
        #
